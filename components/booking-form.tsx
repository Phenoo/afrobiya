...
export default function BookingForm() {
  ...
  return (
    <div className="min-h-[80vh] bg-white max-w-5xl shadow-md rounded-lg w-full mx-auto p-4 overflow-hidden">
      <div className="w-full">
        ...
        <div className="flex gap-2 mb-8">
          ...
          >
            <Image src={"/Flight.svg"} alt="Hotel.svg" width={20} height={20} />
            Flights
          </Button>
          <Button
        ...
        <div className="flex gap-6 w-full">
          ...
          <div className="w-52 bg-white rounded-lg h-fit flex flex-col gap-4">
            {/* Room Basis Section */}
          ...
          <div className="flex-1 w-full bg-white rounded-lg ">
            ...
            <div className="relative mb-6">
              ...
              <Input
                ...
                className="pl-12 pr-12 py-6 text-base border-gray-300 rounded-3xl"
              />
            ...
            <div className="flex gap-2 mb-4">
              ...
              <div className="flex items-center justify-center px-2  py-3  rounded-lg text-sm text-[#808080]">
