    ...
    <>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <h2 className="text-xl ">794 hotels in Abuja, Nigeria</h2>
          <Button
            variant="outline"
            className="gap-0 text-[#666666] border text-xs border-[#CCCCCC] bg-transparent"
          >
        ...
        <div className="space-y-4">
          {hotels.map((hotel) => (
            <div
              key={hotel.id}
              className="bg-white flex flex-col gap-0 border rounded-lg"
            >
              {/* Hotel Image */}
              <div className="flex gap-4">
                ...
                <div className="flex-1 flex justify-between">
                  <div className="flex justify-between flex-col gap-4 p-4">
                    ...
                    <ul className="flex gap-4 list-disc items-center ml-4 text-[#808080]">
                      <li className="mr-4">
                        <Button
                          variant="link"
                  ...
                  {/* Price Section */}
                  <div className="text-center flex flex-col border-l p-4 justify-between">
                    <div className="flex flex-col gap-1">
                      <div className="text-xs text-[#808080]">Starting at</div>
                      <div className="text-2xl  font-medium text-[#0000FF]">
                        ${hotel.price}
                      </div>
                    ...
                    <div className="space-y-3 w-full">
                      {hotelRooms[hotel.id as keyof typeof hotelRooms].map(
                        (room, index) => (
                          <div
                            key={room.id}
                            className={`bg-white flex gap-4 transform transition-all duration-300 ease-out cursor-pointer hover:shadow-md ${
                              showRoomsForHotel === hotel.id
